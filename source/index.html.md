...
<h3 id="#5-patch-parameters">Parameters</h3>
...
<h3 id="#5-patch-responses">Responses</h3>
...
<h3 id="#2-get-users-parameters">Parameters</h3>
...
<h3 id="#2-get-users-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|default|Default|default response|Inline|

<h3 id="#2-get-users-responseschema">Response Schema</h3>
...
<h3 id="#3-create-responses">Responses</h3>
...
<h3 id="#1-get-parameters">Parameters</h3>
...
<h3 id="#1-get-responses">Responses</h3>
...
<h3 id="#4-update-parameters">Parameters</h3>
...
<h3 id="#4-update-responses">Responses</h3>
